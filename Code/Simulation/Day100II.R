...
stopCluster(cl)
write.csv(wosai,"Day100II_a.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_b.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_c.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_d.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_e.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_f.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_g.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_h.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_i.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100II_j.csv")
