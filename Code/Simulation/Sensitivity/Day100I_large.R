...
stopCluster(cl)
write.csv(wosai,"Day100Ia_a.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_b.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_c.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_d.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_e.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_f.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_g.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_h.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_i.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100Ia_j.csv")
