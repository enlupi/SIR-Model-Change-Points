...
stopCluster(cl)
write.csv(wosai,"Day100IIIb_a.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_b.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_c.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_d.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_e.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_f.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_g.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_h.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_i.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIIb_j.csv")
