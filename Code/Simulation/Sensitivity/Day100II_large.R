...
stopCluster(cl)
write.csv(wosai,"Day100IIa_a.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_b.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_c.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_d.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_e.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_f.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_g.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_h.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_i.csv")
...
wosai<- foreach(jishu=rep(1,10),.combine='rbind') %dopar% papapa(jishu)
stopCluster(cl)
write.csv(wosai,"Day100IIa_j.csv")
