...
for(a in Xuan)
{
  Result<-rbind(Result,read.csv(paste(c("Day100I_",a,".csv"),collapse = ""),header = T)[,-1])
}
...
png("Day100I_Summary.png",400,500)
...
png("Day100I_delta_Summary.png",600,400)
...
png("Day100I_CP_Summary.png",600,400)
par(mar=c(5,5,2,2),mfrow=c(1,1))
