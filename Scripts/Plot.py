...
# plot delta probabilities and estimate    
...
# plot beta and gamma estimators
...
# plot distribution of samples along the chain and estimators for specific times
